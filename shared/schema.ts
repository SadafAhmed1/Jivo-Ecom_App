...
// SC_Swiggy_JM_Daily - Swiggy Jivo Mart Daily
export const scSwiggyJmDaily = pgTable("SC_Swiggy_JM_Daily", {
  ...
  store_id: varchar("store_id", { length: 50 }),
  l1_category: varchar("l1_category", { length: 200 }),
  l2_category: varchar("l2_category", { length: 200 }),
  l3_category: varchar("l3_category", { length: 200 }),
  product_name: text("product_name").notNull(),
  variant: varchar("variant", { length: 200 }),
  item_code: varchar("item_code", { length: 100 }),
  combo: varchar("combo", { length: 10 }),
  combo_item_code: varchar("combo_item_code", { length: 100 }),
  combo_units_sold: integer("combo_units_sold"),
  base_mrp: decimal("base_mrp", { precision: 15, scale: 2 }),
  units_sold: integer("units_sold"),
  gmv: decimal("gmv", { precision: 15, scale: 2 }),
  created_at: timestamp("created_at").defaultNow(),
  updated_at: timestamp("updated_at").defaultNow()
});

// SC_Swiggy_JM_Range - Swiggy Jivo Mart Date Range  
...
// Insert schemas for Swiggy tables
export const insertScSwiggyJmDailySchema = createInsertSchema(scSwiggyJmDaily).omit({
  id: true,
  created_at: true,
  updated_at: true
});

export const insertScSwiggyJmRangeSchema = createInsertSchema(scSwiggyJmRange).omit({
  id: true,
  created_at: true,
  updated_at: true
});

// Types for Swiggy tables
export type ScSwiggyJmDaily = typeof scSwiggyJmDaily.$inferSelect;
export type InsertScSwiggyJmDaily = z.infer<typeof insertScSwiggyJmDailySchema>;
export type ScSwiggyJmRange = typeof scSwiggyJmRange.$inferSelect;
export type InsertScSwiggyJmRange = z.infer<typeof insertScSwiggyJmRangeSchema>;
